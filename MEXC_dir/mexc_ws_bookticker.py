...
import sys
import os
from MEXC_websocket_collection_class import mexc_websocket_collection
...
LOCK_FILE = '/tmp/mexc_ws_bookticker.lock'
...
async def main():
    ...
    try:
        ...
        directory = '/root/trading_systems/MEXC_dir/new_pair_dir_mexc'
        testing = False
        testing_time = 3
        if testing:
            symbol = 'BTC'
            ...
            try:
                change_data = await scraper.get_price_websocket_bookticker(
                    symbol,
                    max_wait_time=10,
