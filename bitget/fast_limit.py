...
async def main():
    ...
    logger.info(f'order initilaized')
    ...
    async with aiohttp.ClientSession() as session:
        ...
        order_response = await place_limit_order_session(session, base_url, headers, request_path, body_json)
...
async def place_limit_order_session(session, base_url,headers,request_path, body_json):
